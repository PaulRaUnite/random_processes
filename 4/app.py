...
plt.clf()
half = {"index": index[:part+1], "original": work_series[:part+1],"Yn=a*Yn-1+b": AUTOPREV_HALF, "Yn=a*t+b": AUTOTIME_HALF}
...
clust_data = list(zip(index, original_series, work_series, AUTOPREV, list(map(lambda a,b: a-b, work_series, AUTOPREV))))
